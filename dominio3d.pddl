...
(define (domain dominio3d)
    ...
    ; Forma una comunidad reducida a partir de tres Hobbit, un Mago y un Elfo que están en la misma localización.
    (:action formarComunidad
        :parameters (?hob1 - Personaje ?hob2 - Personaje ?hob3 - Personaje ?mag - Personaje ?elf - Personaje ?loc - Localizacion)
        :precondition (and 
            ; la comunidad no puede estar ya formada
            (not (comunidadFormada))
            ; los personajes tienen que ser tres hobbit, un mago y un elfo
            (personajeEs ?hob1 Hobbit)
            (personajeEs ?hob2 Hobbit)
            (personajeEs ?hob3 Hobbit)
            (personajeEs ?mag Mago)
            (personajeEs ?elf Elfo)
    ...
    (:action viajarComunidad
        :parameters (?hob1 - Personaje ?hob2 - Personaje ?hob3 - Personaje ?mag - Personaje ?elf - Personaje ?origen - Localizacion ?destino - Localizacion)
        :precondition (and 
