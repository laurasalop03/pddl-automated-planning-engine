...
(define (domain dominio3b)
    ...
    ; Forma una comunidad a partir de dos Hobbit y un Mago que están en la misma localización.
    (:action formarComunidad
        :parameters (?hob1 - Personaje ?hob2 - Personaje ?mag - Personaje ?loc - Localizacion)
        :precondition (and 
            ; la comunidad no puede estar ya formada
            (not (comunidadFormada))
            ; los personajes tienen que ser dos hobbit y un mago
            ...
            ; forzamos a que se elijan en orden para romper las simetrías
            (menor ?hob1 ?hob2)
        )
        :effect (and 
    ...
    (:action viajarComunidad
        :parameters (?hob1 - Personaje ?hob2 - Personaje ?mag - Personaje ?origen - Localizacion ?destino - Localizacion)
        :precondition (and 
