...
(define (problem problema3b) 
    ...
    (:init
        ...
        ; Imponemos el orden de los Hobbits para romper las simetrias
        (menor Hobbit1 Hobbit2)
        (menor Hobbit1 Hobbit3)
        (menor Hobbit1 Hobbit4)
        (menor Hobbit2 Hobbit3)
        (menor Hobbit2 Hobbit4)
        (menor Hobbit3 Hobbit4)
